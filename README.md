...
| [`orx/final-release-gate-and-existing-space-publicatio`](https://github.com/MachineLearning-Nerd/icml26-repro-KS6RbZMt8L-complexity-of-decentralized-optimization-with-mixed-affine-constraints/tree/orx/final-release-gate-and-existing-space-publicatio) | Hash-locked publication candidate for the existing Space | `uv sync --frozen && uv run --frozen python reproduce.py` | Final cumulative rerun and publication source | HF `cpu-upgrade`, estimated 16 cores, no GPU |
