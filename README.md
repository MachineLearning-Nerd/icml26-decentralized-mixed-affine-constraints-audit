...
| [`orx/evaluator-blind-release-candidate-and-publicatio`](https://github.com/MachineLearning-Nerd/icml26-repro-KS6RbZMt8L-complexity-of-decentralized-optimization-with-mixed-affine-constraints/tree/orx/evaluator-blind-release-candidate-and-publicatio) | Exact release allowlist, subset proof, and evaluator-blind traversal | `uv sync --frozen && uv run --frozen python reproduce.py` | Final release gate; result recorded on completion | HF `cpu-upgrade`, estimated 16 cores, no GPU |
