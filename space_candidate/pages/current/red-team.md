...
No reviewer hint beyond the canonical entrypoint was used. The Hugging Face release-gate verifier repeats the target and hash checks and exits nonzero for any regression.
